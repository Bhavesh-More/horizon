...
4. Monorepo signal: workspace markers (Yarn workspaces via a `"workspaces"` field in `package.json` or `yarn.lock`, `turbo.json`) or any `apps/*/package.json` / `packages/*/package.json` near the root.
